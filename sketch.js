...
function setup() {
	...
	roofObject=new roof(830,250,230,20);
	bob1 = new bob(750,575,40)
	bob2 = new bob(790,575,40)
	bob3 = new bob(830,575,40)
	bob4 = new bob(870,574,40)
	bob5 = new bob(910,573,40)
